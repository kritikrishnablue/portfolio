...
const Contact = () => {
  return (
    <div className='flex flex-col items-center bg-gray-100'>
      ...
      <form action="" className='flex flex-col bg-white text-gray-500 shadow-2xl p-6 sm:p-12 mb-16 sm:mb-28 w-[90%] max-w-3xl mx-4'>
        <label htmlFor="name" className='text-gray-600 font-bold text-sm'>Name</label>
        <input type="text" id="name" placeholder='Enter your name' className='w-full h-12 rounded-sm bg-gray-200 mb-8 placeholder:text-base p-2'/>
        <label htmlFor="email" className='text-gray-600 font-bold text-sm'>Email</label>
        <input type="email" id="email" placeholder='Enter your email' className='w-full h-12 rounded-sm bg-gray-200 mb-8 placeholder:text-base p-2'/>
        <label htmlFor="message" className='text-gray-600 font-bold text-sm'>Message</label>
        <textarea id="message" placeholder='Enter your message' className='w-full h-52 rounded-sm bg-gray-200 mb-8 placeholder:text-base p-2 resize-none'/>

  ...
  return (
    <div id='home' className='min-h-screen'>
      <div className='bg-gray-100 flex flex-col text-center items-center justify-center min-h-screen bg-[url("/background.svg")] bg-cover bg-center'>
        ...
        <button onClick={scrollToProjects} className='bg-pink-700 px-20 py-4 sm:px-24 sm:py-4 rounded-md text-white font-extrabold text-xl sm:text-2xl hover:bg-pink-800 transition-colors duration-700'>Projects</button>
      </div> 
      <Sidebar1/>
    </div>
  )
